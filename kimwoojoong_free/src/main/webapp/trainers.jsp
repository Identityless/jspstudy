	...
	<nav class="navbar navbar-dark bg-dark fixed-top">
		<div class="container-fluid">
			<a class="navbar-brand"
				href="http://localhost:8080/kimwoojoong_free/FitnessServlet?cmd=main&login=true">INTHERAIN
				FITNESS</a>
			...
			<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1"
				...
				<div class="offcanvas-header">
					<h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">안녕하세요,
						${member.getUname()}님</h5>
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
						<li class="nav-item"><a class="nav-link"
							href="http://localhost:8080/kimwoojoong_free/FitnessServlet?cmd=main&cmd=main&login=true">Home</a></li>
						<li class="nav-item"><a class="nav-link"
							href="http://localhost:8080/kimwoojoong_free/FitnessServlet?cmd=trainers">Trainers</a></li>
						<li class="nav-item"><a class="nav-link" href="">Members</a></li>
						<li class="nav-item"><a class="nav-link"
							href="http://localhost:8080/kimwoojoong_free/">Logout</a></li>
					</ul>
				</div>
			</div>
		</div>
