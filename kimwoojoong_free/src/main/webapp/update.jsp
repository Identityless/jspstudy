...
<head>
<meta charset="UTF-8">
<title>InTheRain Fitness | Update</title>
...
<body class="text-center">
	...
	<div class="form-signin w-100 m-auto">
		<form
			action="http://localhost:8080/kimwoojoong_free/FitnessServlet?cmd=update"
			method="post">
			<img class="mb-4"
			...
			<div class="form-floating">
				<input type="text" class="form-control" name="id" required
					placeholder="ID" value="${member.getId() }" readonly> <label
					for="floatingInput">ID</label>
			</div>
			<div class="form-floating">
				<input type="password" class="form-control" name="passwd" required
					placeholder="PASSWORD" value="${member.getPasswd() }"> <label
					for="floatingInput">PASSWORD</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control" name="uname" required
					placeholder="NAME" value="${member.getUname() }"> <label
					for="floatingInput">NAME</label>
			</div>
			<div class="form-floating">
				<input type="number" class="form-control" name="age" required
					placeholder="AGE" value="${member.getAge() }"> <label
					for="floatingInput">AGE</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control" name="sex" required
					placeholder="SEX" value="${member.getSex() }"> <label
					for="floatingInput">SEX</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control" name="address" required
					placeholder="OO도 OO시 OO구 OO동" value="${member.getAddress() }">
				<label for="floatingInput">ADDRESS</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control" name="tell" required
					placeholder="TELL" value="${member.getTell() }"> <label
					for="floatingPassword">TELL</label>
			</div>
			<select name="trainer">
